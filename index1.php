...
<head>
  ...
  <title>SELLPHONE - Your Phone Reservation & Monitoring Platform</title>
  <meta content="SellPhone - Your go-to destination for streamlined phone reservation and monitoring." name="description">
  <meta content="phone, reservation, monitoring" name="keywords">
...
<body>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            ...
            <p data-aos="fade-up">Your go-to destination for streamlined phone reservation and monitoring.</p>
            <a href="products.php" class="btn-get-started" data-aos="fade-up" data-aos-delay="200">Reserve Now</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container" data-aos="fade-up">
    ...
    <header class="section-header">
      <h2>Key Features</h2>
      <p>Discover the features that make SellPhone your ideal phone reservation and monitoring platform.</p>
    </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="icon-box" data-aos="fade-up">
          ...
          <h4 class="title"><a href="">Effortless Reservation</a></h4>
          <p class="description">Browse through our wide selection of smartphones and reserve your desired model in just a few clicks.</p>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
          ...
          <h4 class="title"><a href="">Flexible Pickup</a></h4>
          <p class="description">Choose your preferred pickup date and location to suit your schedule and convenience.</p>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
        <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
          ...
          <p class="description">Stay updated on the availability of your reserved phone and receive notifications on its status.</p>
        </div>
      </div>
