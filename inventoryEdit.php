...
if ( $_SERVER['REQUEST_METHOD'] == 'GET'){
    ...
    $phoneAvailability = $row["phoneAvailability"];
    ...
    do {
        ...
        $sql =  "UPDATE phonetbl " .
                "SET phoneBrand = '$phoneBrand', phoneModel = '$phoneModel', phoneStorage = '$phoneStorage', phoneColor = '$phoneColor', phoneAvailability = '$phoneAvailability', phoneQuantity = '$phoneQuantity', phonePrice = '$phonePrice', phoneImage = '$phoneImage', phoneDescription = '$phoneDescription' " .
